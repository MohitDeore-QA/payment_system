...
class WithdrawalAmountPage(BasePage):

    _withdrawal_tab = (By.XPATH, "//a[normalize-space()='Withdrawal']")
    ...
    def open_withdrawal_tab(self):
        self.click(self._withdrawal_tab)

    def get_header_text(self):
        return self.get_text(self._header)

    def withdraw_amount(self, account_id, amount, reason):
